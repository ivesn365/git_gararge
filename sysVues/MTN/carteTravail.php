        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="vehiculeTable" class="table table-bordered table-hover align-middle text-center">
                    ...
                    <?php
                    $j = 1;
                    $garage = Garage::affichers("SELECT * FROM garage WHERE status=1");
                    if ($garage){
                        foreach ($garage as $item){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger" href="pages-formCloture-<?=$item->getId()?>" >Clôturer</a>
