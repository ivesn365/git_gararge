<div class="col-12 grid-margin stretch-card mt-4">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Liste des anomalies</h4>
            <a href="page-formAnomalie" class="btn btn-primary mb-3" >Formulaire</a>
    ...
    <table id="vehiculeTable" class="table table-bordered table-hover align-middle text-center">
        ...
        <?php
        $j = 1;
        $anomalie = Panne::affichers("SELECT * FROM panne WHERE status=1");
        if ($anomalie){
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-info" href="pages-formInstruction-<?=$i->getId()?>">Confirmer</a>
