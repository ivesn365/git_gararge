...
<div class="container bg-white p-4 rounded shadow mb-5">
    <h2 class="mb-4">🛠️ Générer un Rapport des courses</h2>

    <form action="rapportCourse.php" method="POST" class="row g-3">
        <!-- Date de début -->
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <select id="etat" name="etat" class="form-select" required>
                <option value="0" selected>Tous</option>
                <option value="1">Prévision de Course</option>
                <option value="2">Course Réalisée</option>
            </select>
        </div>
